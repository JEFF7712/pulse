...
assert_contains "$quickstart_html" 'This page renders the canonical repo doc'
assert_contains "$quickstart_html" 'docs/self-hosting/quickstart.md'
assert_contains "$configuration_html" 'Configuration Reference'
assert_contains "$configuration_html" 'PULSE_DATABASE_PATH'
assert_contains "$configuration_html" 'This page renders the canonical repo doc'
assert_contains "$configuration_html" 'docs/reference/configuration.md'
assert_contains "$runbook_html" 'Operations Runbook'
assert_contains "$runbook_html" 'GET /health'
assert_contains "$runbook_html" 'This page renders the canonical repo doc'
assert_contains "$runbook_html" 'docs/operations/runbook.md'
assert_contains "$connectors_html" 'Connectors Index'
assert_contains "$connectors_html" 'pulse auth spotify'
assert_contains "$connectors_html" 'This page renders the canonical repo doc'
assert_contains "$connectors_html" 'docs/connectors/index.md'
